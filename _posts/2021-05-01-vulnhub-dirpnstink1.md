...
![[/assets/img/vuln-dirpnstink/Pasted image 20210430221504.png]]

## Webserver

The default page was static website.

![[/assets/img/vuln-dirpnstink/Pasted image 20210430221908.png]]

Looking at the source code of the static website, there is webnotes directory with a filename info.txt

![[/assets/img/vuln-dirpnstink/Pasted image 20210430222024.png]]

The content of the info.txt was as shown below.

![[/assets/img/vuln-dirpnstink/Pasted image 20210430222243.png]]

This suggests there might be virtual host routing in play.

![[/assets/img/vuln-dirpnstink/Pasted image 20210430222452.png]]

Going one directory up to ```/webnotes```, reveals output of commands run in the server.

![[/assets/img/vuln-dirpnstink/Pasted image 20210430222748.png]]
...
![[/assets/img/vuln-dirpnstink/Pasted image 20210430224256.png]]
...
![[/assets/img/vuln-dirpnstink/Pasted image 20210430231923.png]]

The slide-show plugin installed is outdated as shown by wpscan
![[/assets/img/vuln-dirpnstink/Pasted image 20210430232459.png]]
...
![[/assets/img/vuln-dirpnstink/Pasted image 20210501121154.png]]

## Foothold

There are 2 users in the machine ```stinky, mrderp``` 

![[/assets/img/vuln-dirpnstink/Pasted image 20210501122133.png]]

I tried to write ssh key into their ```.ssh/authorized_keys``` but was unsuccessful.

![[/assets/img/vuln-dirpnstink/Pasted image 20210501122835.png]]

I set up netcat listener and executed php reverse shell.

![[/assets/img/vuln-dirpnstink/Pasted image 20210501123315.png]]
...
![[/assets/img/vuln-dirpnstink/Pasted image 20210501125838.png]]
...
![[/assets/img/vuln-dirpnstink/Pasted image 20210501132218.png]]
...
![[/assets/img/vuln-dirpnstink/Pasted image 20210501143030.png]]
...
![[/assets/img/vuln-dirpnstink/Pasted image 20210501144424.png]]
